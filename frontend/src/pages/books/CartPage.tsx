...
const CartPage = () => {
  ...
  const totalPrice = cartItems.reduce((acc: number, item: Book) => {
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="ml-3 flex h-7 items-center">
            <button
              ...
              type="button"
              className="hover:bg-secondary relative -m-2 rounded-md bg-red-500 px-2 py-1 text-white transition-all duration-200"
            >
